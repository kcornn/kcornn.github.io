      ...
      {portfolioView === "experience" ? (
        <>
          ...
          <motion.section id="experience" className="section" {...baseAnim}>
            ...
            <ul>
              ...
              <li>
                ...
                increase adoption and retention of component scorecards, working
                closely with design and product to refine the UI experience.
                Increased percentage of users taking action within Compass after
                onboarding from 45% to 65%.
              </li>
              <li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Attended TechTogether Boston 2020: Atlassian representative
                    at career fair, presented at women in tech session, judged
          ...
          >
            <h2>Research</h2>
            <p>
              Associate Investigator and Statistician, University of California,
            ...
            <ul>
              <li>
                Used Python to clean/analyze data and create data visualizations
                for a study analyzing the role of digital assistants in
                autonomous vehicle ride experiences, sponsored by Ford.
              </li>
            </ul>
            <h3>Publications</h3>
            <p>
              ...
              Hills-Bunnell, D.J., et al. (2020). Capturing Passenger Experience
              in a Ride-Sharing Autonomous Vehicle: The Role of Digital
              Assistants in User Interface Design. In 12th International
              Conference on Automotive User Interfaces and Interactive Vehicular
              Applications (AutomotiveUI '20). Association for Computing
              Machinery, New York, NY, USA, 83–93.{" "}
              <a
          ...
          >
            ...
            <ul>
              ...
              <li>
                CS 193C (Client-Side Technologies) Course Assistant, Summer 2018
                and Summer 2019
              </li>
              <li>
